<template>
  <div
    ...
    "
    class="bg-black-highest sm:px-8 px-4 py-4 relative z-[100] -mt-[70px] w-full flex flex-col items-center"
  >
    <div
      class="w-full mt-[121px] flex flex-col gap-[16px] items-center justify-center"
    >
      <h1 class="font-bold lg:text-[36px] text-[24px] text-white text-center">
        Events You Love. Tickets You Trust
      </h1>
      <p
    ...
    >
      ...
      <div
        class="text-white w-full lg:w-auto text-center mt-4 lg:mt-0 lg:order-none order-last text-[16px]"
      >
        <p>© 2025 Onetix. All Rights Reserved.</p>
      </div>
...
const footerIcons = [
  {
    name: "Instagram",
    icon: IconsInstagram,
    link: "https://www.instagram.com/playballafrica/?igshid=MzRlODBiNWFlZA%3D%3D",
  },
  { name: "Whatsapp", icon: IconsWhatsapp, link: "https://wa.link/5jtg55" },
  {
    name: "Twitter",
    icon: IconsTwitter,
    link: "https://twitter.com/playballafrica?s=21&t=eFVl3LBhxYW7ARvGCbrHKQ",
  },
];
</script>
